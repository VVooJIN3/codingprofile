                    ...
                    if ($('#name').text() == a['name']) {
                        let temp_html = `<div class="card">
                                            <div class="card-body">
                                                ...
                                                <button onclick="edit-button-${commentIdx}" type="button" class="btn btn-outline-secondary" onclick="editbutton_clicked(this)" value="${commentIdx}" data-id="${objectId}">수정</button>
                                                <button id="done-button-${commentIdx}" style="display: none;" class="done-button-${commentIdx}" onclick="donebutton_clicked(this)" value="${commentIdx}" data-id="${objectId}">완료</button>
                                                <button onclick="delete-button-${commentIdx}" type="button" class="btn btn-outline-secondary" onclick="donebutton_clicked(this)" value="${commentIdx}" data-id="${objectId}">삭제</button>
                                                </div>
                                                <div class="input-group flex-nowrap">
                                                <span class="input-group-text" id="addon-wrapping">PW</span>
                                                <input type="password" class="form-control" placeholder="Password" aria-label="Username" aria-describedby="addon-wrapping" id="password">
                                                </div>
                                            </div>
                                        </div>`
                        $('#comment-list').append(temp_html)
